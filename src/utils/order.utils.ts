import type { OrderResponse, OrderResponseWithMessage } from '../types/order.types';
...
export const transformOrderToResponse = (
    ...
    return {
        ...
        deliveryAddress: {
            streetAddress: ((orderData.deliveryAddress as unknown) as PopulatedAddress).streetAddress,
            ...
            landmark: ((orderData.deliveryAddress as unknown) as PopulatedAddress).landmark
        },
        paymentNumber: {
            number: ((orderData.paymentNumber as unknown) as PopulatedPaymentNumber).number,
            provider: ((orderData.paymentNumber as unknown) as PopulatedPaymentNumber).provider
        },
